...
#Part.i Abstract
  ...
  Tools and data used @citetidyverse, @citeopendatatoronto
...
#Part.v Limitations 
  ...
  3. People with mild symptoms may not report themselves to Public Health since the case report is not mandatory (non-mandatory policy intervention), thus infection date can not represent the true situation that we facing right now. 
